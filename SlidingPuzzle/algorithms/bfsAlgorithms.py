...
import sys
sys.path.append("C:/Users/qtt15/OneDrive - Hanoi University of Science and Technology/SlidingPuzzleGame/SlidingPuzzle/utils")
sys.path.append("C:/Users/qtt15/OneDrive - Hanoi University of Science and Technology/SlidingPuzzleGame/SlidingPuzzle/nodeSlidingPuzzle")
import  utils
import goalState
...
def bfs(root,goal_states,n):  # giải bfs khác human là không có heuristic=0, và cũng không cần vòng lặp while vì nó chỉ có 1 bước đích
    ...
    path = "C:\\Users\\qtt15\\OneDrive - Hanoi University of Science and Technology\\SlidingPuzzleGame\\SlidingPuzzle\\inputOutput\\solution.txt"
    f = open(path, "w")
    f.truncate(0)
    while len(h) > 0:
        count += 1
